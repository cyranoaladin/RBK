...
\keepXColumns
\makeatletter
\newenvironment{RBKLongTableX}[2]{\tabularx{#1}{#2}}{\endtabularx}
\makeatother
...
\input{tex/terminology_core.tex}
\input{tex/terminology_entries.tex}
...
\newcommand{\RBKRACI}[1]{
  ...
  \renewcommand{\arraystretch}{1.25}
  \begin{tabularx}{\linewidth}{|p{4.5cm}|p{2cm}|p{2cm}|Y|Y|}
    \hline
...
% ----------------------------
% ----------------------------
% Custom TOC (Manual Hardcoded) - "Nuclear Option" for Visibility
% ----------------------------
\usepackage[titles]{tocloft}

% Couleurs RBK
\definecolor{RBKPurple}{HTML}{8A2BE2}
\definecolor{RBKTeal}{HTML}{00C9A7}
\definecolor{RBKGray}{gray}{0.25}

% 0. Hyperref: Pas de cadres rouges, Liens colorés
\hypersetup{
    colorlinks=true,
    linkcolor=RBKPurple,
    citecolor=RBKPurple,
    urlcolor=RBKTeal,
    pdfborder={0 0 0},
    pdftitle={Livre Blanc RBK 5.0},
    pdfauthor={Money Factory AI},
    pdfsubject={Architecture de la Souveraineté Numérique},
    pdfkeywords={Blockchain, Solana, Rust, Education},
    bookmarksnumbered=true
}

% 1. Config Looks (TOCLOFT)
% Chapitres
\renewcommand{\cftchapfont}{\bfseries\large\color{RBKPurple}}
\renewcommand{\cftchappagefont}{\bfseries\color{RBKPurple}}
\renewcommand{\cftchapleader}{\bfseries\color{RBKPurple}\cftdotfill{\cftdotsep}}
...
% Subsections
\renewcommand{\cftsubsecfont}{\footnotesize\color{RBKGray}}
\renewcommand{\cftsubsecpagefont}{\footnotesize\color{RBKGray}}
...
% 2. Redéfinition TOTALE de \tableofcontents
% On court-circuite tout package qui tenterait de masquer le titre
\makeatletter
\renewcommand{\tableofcontents}{%
    ...
    \begingroup
        \parindent0pt
        \centering
        \fontsize{22}{26}\selectfont\bfseries\color{RBKPurple} TABLE DES MATIÈRES
        \par\vspace{6pt}
        {\color{RBKTeal}\hrule height 1pt}
        \par\vspace{20pt}
    \endgroup
    % Corps de la TOC
    \begingroup
...
\begin{titlepage}
	...
	\begin{center}
		\includegraphics[height=2.5cm]{Money_Factory_AI.png}
		\hspace{2cm}
		\includegraphics[height=2.5cm]{RBK.png}
	\end{center}
...
% Custom TOC Name
% Custom TOC Name handled in preamble
\tableofcontents
\newpage
...
\input{chapters/annexe_x_traceability.tex}
\input{chapters/annexe_y_change_control.tex}
\input{chapters/annexe_z_glossaire.tex}
