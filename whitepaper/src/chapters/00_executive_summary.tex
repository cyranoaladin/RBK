...
\begin{itemize}
    ...
    \item \textbf{Certification On-Chain :} Diplôme \textbf{SBT (Soulbound Token)} infalsifiable et composable.
    \item \textbf{Statut ETE (Exportateur) :} Exonération d'impôt (4 ans) et gestion native des devises/crypto pour les diplômés.
    \item \textbf{Cible revenu diplômé :} \textbf{3\,500 TND nets/mois (local)} ou \textbf{équivalent devise} (remote).
\end{itemize}
