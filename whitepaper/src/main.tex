...
\definecolor{SOLANAPURPLE}{HTML}{9945FF} % Fix for uppercase headers
...
\providecommand{\rbkIcon}[2][]{\texorpdfstring{\faIcon{#2}}{#2}}
...
\input{chapters/11b_fiches_metiers.tex}
...
% 15b. Infrastructure SBT (Nouvel Ajout)
\input{chapters/19_sbt_infrastructure.tex}

% 16. Roadmap & Plan de Lancement
\input{chapters/16_roadmap.tex}
...
\appendix
% Annexes are inherently numbered A, B, C... by \appendix
...
\input{chapters/annexe_m_partenariats.tex}
\input{chapters/annexe_n_outillage.tex}
\input{chapters/annexe_o_competences.tex}
\input{chapters/annexe_p_qualite.tex}
\input{chapters/annexe_q_contrat_isa.tex}
\input{chapters/annexe_r_contrat_b2b.tex}
\input{chapters/annexe_s_kit_juridique.tex}
