...
\begin{enumerate}
    ...
    \item Pipeline \RBKTerm{ci_cd} pour la correction automatique des exercices (Rust/Solidity).
...
\textbf{Owner :} COO / Legal. \textbf{\RBKTerm{dod} :} Tous les contrats sont signés et stockés sécurisés.
\begin{itemize}
...
\begin{itemize}
    \item P0 : Configuration Workspace \RBKTerm{github} (Orga, Teams, Permissions).
...
\begin{itemize}
    ...
    \item P1 : Campagne \RBKTerm{linkedin}/Twitter "Building in Public" (Daily).
\end{itemize}

Les actions opérationnelles s’appuient sur une coordination \RBKTerm[Ops]{ops} et un suivi \RBKTerm{crm} pour tracer l’acquisition et la montée en charge.
