\chapter{SYLLABUS TECHNIQUE DÉTAILLÉ (48 SEMAINES)}
...
\begin{center}
    ...
    \begin{tabular}{|c|p{4cm}|p{5cm}|p{2.5cm}|}
        ...
        S1 & Syntaxe & CLI Todo List & No panic \\ \hline
        ...
        \multicolumn{4}{|c|}{\textbf{PHASE 2 : SPÉCIALISATION (S13-S28)}} \\ \hline
        S13 & Anchor Framework & Basic Vault & Secure \\ \hline
        S28 & Security Deep Dive & Hacking Challenge & Flag Captured \\ \hline
        \multicolumn{4}{|c|}{\textbf{PHASE 3 : PROFESSIONNALISATION (S29-S48)}} \\ \hline
        S48 & Final Demo & Production Release & Audit Approved \\ \hline
    \end{tabular}
\end{center}
