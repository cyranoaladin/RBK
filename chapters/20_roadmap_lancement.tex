...
\label{chap:roadmap_lancement}

\section{MOIS 1 : CADRAGE, ALLIANCE \& ÉQUIPE NOYAU (J0 - J30)}

\subsection{Validation \& Cadrage Stratégique}
\begin{itemize}
    \item Finalisation du modèle financier et des projections de cash-flow.
    \item Signature de l'accord de partenariat avec Money Factory AI (Apporteur curriculaire).
\end{itemize}

\subsection{Constitution de l'Alliance Écosystémique}
\begin{itemize}
    \item Signature des MOU avec les partenaires locaux (Universités, Incubateurs).
    \item Validation du soutien de la Solana Foundation (Superteam).
\end{itemize}
...
\begin{itemize}
    ...
    \item Identification du pool de mentors internationaux (Guest Lecturers).
\end{itemize}
...
\begin{itemize}
    ...
    \item Acquisition des licences pour les outils d'IA (Cursor, Windsurf) et de simulation.
    \item Installation du LMS et du serveur Discord comme hub de communication principal.
\end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{La « Piscine » Rust :} Lancement de la phase de filtrage intensif de 4 semaines sans IA pour les 20 candidats présélectionnés.
\end{itemize}
...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{|l|l|X|}
        \hline
        \textbf{Délai} & \textbf{Jalon} & \textbf{Impact} \\ \hline
        J+15 & MOU Solana Foundation signé & Crédibilité internationale immédiate. \\ \hline
        J+30 & Équipe pédagogique complète & Capacité de production activée. \\ \hline
        J+45 & Golden Templates livrés & Standard de qualité « Senior-by-Design » fixé. \\ \hline
        J+60 & 100 leads qualifiés générés & Sécurité du taux de remplissage. \\ \hline
        J+75 & Fin de la « Piscine » Rust & Cohorte d'élite validée. \\ \hline
        J+90 & Lancement officiel Promo Alpha & Début de la transformation de RBK. \\ \hline
    \end{tabularx}
\end{table}

\begin{ceoBox}{Annotation Stratégique}
