...
\begin{itemize}
    \item \textbf{Panier Moyen Upfront :} Estimé à \textbf{9 300 TND} (Mix pondéré entre N1 seul, N1+N2 et Pack Complet).
    \item \textbf{Revenu Moyen ISA :} Estimé à \textbf{18 000 TND} sur 3 ans (basé sur salaire moyen junior 2 800 TND).
...
\begin{center}
    ...
    \begin{tabular}{|l|r|l|}
        ...
        \textbf{Revenu Moyen (A)} & \textbf{9 300} & Mix Upfront/ISA pondéré \\ \hline
        ...
        \textbf{Marge Contributive (A-B)} & \textbf{7 000} & \textbf{75\% de Marge Brute} \\ \hline
    \end{tabular}
\end{center}
